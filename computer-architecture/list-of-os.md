...
スティーブ・ジョブズは1985年にApple Inc.を退社し、NeXT Inc.を設立しました。これらのコンピュータのうちの1台は、ティム・バーナーズ＝リーがWorld Wide Webを作成するための最初のウェブサーバとして使用しました。
...
| Update method                                                | System Preferences ([10.14+](https://en.wikipedia.org/wiki/MacOS_Mojave))[Mac App Store](https://en.wikipedia.org/wiki/Mac_App_Store) ([10.(https://en.wikipedia.org/wiki/OS_X_Mountain_Lion)–[10.(https://en.wikipedia.org/wiki/MacOS_High_Sierra))Software Update ([10.(https://en.wikipedia.org/wiki/Mac_OS_X_10.0)–[10.(https://en.wikipedia.org/wiki/Mac_OS_X_Lion)) |
| Platforms                                                    | [x86-(https://en.wikipedia.org/wiki/X86-64) ([10.4.(https://en.wikipedia.org/wiki/Mac_OS_X_Tiger)–present)[IA-(https://en.wikipedia.org/wiki/IA-32) ([10.4.(https://en.wikipedia.org/wiki/Mac_OS_X_Tiger)–[10.6.(https://en.wikipedia.org/wiki/Mac_OS_X_Snow_Leopard); **discontinued**)[PowerPC](https://en.wikipedia.org/wiki/PowerPC) ([10.(https://en.wikipedia.org/wiki/Mac_OS_X_10.0)–[10.5.(https://en.wikipedia.org/wiki/Mac_OS_X_Leopard); **discontinued**) |
...
| Platforms                                                    | [IBM ROMP](https://en.wikipedia.org/wiki/IBM_ROMP), [IBM POWER](https://en.wikipedia.org/wiki/IBM_POWER_instruction_set_architecture), [PowerPC](https://en.wikipedia.org/wiki/PowerPC), [x(https://en.wikipedia.org/wiki/X86) ([IBM PS/(https://en.wikipedia.org/wiki/IBM_PS/2)), [System/(https://en.wikipedia.org/wiki/System/370), [ESA/(https://en.wikipedia.org/wiki/ESA/390) |
...
| [Latest release](https://en.wikipedia.org/wiki/Software_release_life_cycle) | [Android (https://en.wikipedia.org/wiki/Android_10) / September 3, 2019; 7 months ago[[3\]](https://en.wikipedia.org/wiki/Android_(operating_system)#cite_note-3) |
...
| Platforms                                                    | [32-](https://en.wikipedia.org/wiki/32-bit) and [64-bit](https://en.wikipedia.org/wiki/64-bit_computing) [ARM](https://en.wikipedia.org/wiki/ARM_architecture), [x(https://en.wikipedia.org/wiki/X86) and [x86-(https://en.wikipedia.org/wiki/X86-64) |
...
| [License](https://en.wikipedia.org/wiki/Software_license)    | [Apache License](https://en.wikipedia.org/wiki/Apache_License) 2.0[GNU GPL](https://en.wikipedia.org/wiki/GNU_GPL) v2 for the [Linux kernel](https://en.wikipedia.org/wiki/Linux_kernel) modifications[[9\]](https://en.wikipedia.org/wiki/Android_(operating_system)#cite_note-License-9) |
...
| Platforms                                                    | Current: [x86-(https://en.wikipedia.org/wiki/X86-64), [64-bit ARM](https://en.wikipedia.org/wiki/ARM_architecture#64/32-bit_architecture) Historical: [PowerPC](https://en.wikipedia.org/wiki/PowerPC), [IA-(https://en.wikipedia.org/wiki/IA-32), [32-bit ARM](https://en.wikipedia.org/wiki/ARM_architecture#32-bit_architecture) (32-bit ARM support was closed-source) |
...
| Platforms                                                    | [IA-(https://en.wikipedia.org/wiki/IA-32), [x86-(https://en.wikipedia.org/wiki/X86-64), [ARM](https://en.wikipedia.org/wiki/ARM_architecture) |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Hybrid](https://en.wikipedia.org/wiki/Hybrid_kernel)        |
...
| Preceded by                                                  | [Mach](https://en.wikipedia.org/wiki/Mach_(kernel)), [Nukernel](https://en.wikipedia.org/wiki/Nukernel) |
...
| Platforms                                                    | [x86-(https://en.wikipedia.org/wiki/X86-64)               |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Hybrid](https://en.wikipedia.org/wiki/Hybrid_kernel)        |
...
| [Package manager](https://en.wikipedia.org/wiki/Package_manager) | pkg                                                          |
| Platforms                                                    | [ARM](https://en.wikipedia.org/wiki/ARM_architecture), [IA-(https://en.wikipedia.org/wiki/IA-32), [x86-(https://en.wikipedia.org/wiki/X86-64), [MIPS](https://en.wikipedia.org/wiki/MIPS_architecture), [PowerPC](https://en.wikipedia.org/wiki/PowerPC), 64-bit [SPARC](https://en.wikipedia.org/wiki/SPARC), [RISC-V](https://en.wikipedia.org/wiki/RISC-V) |
...
コンピュータフォントの中には、小文字のLと大文字のiを明確に区別できないものがあるため、メンテナはイルモを小文字で書く[citation needed]（ホモグリフを参照）。
...
| :----------------------------------------------------------- | ------------------------------------------------------------ |
| [Written in](https://en.wikipedia.org/wiki/Programming_language) | [C](https://en.wikipedia.org/wiki/C_(programming_language))  |
| OS family                                                    | [Unix](https://en.wikipedia.org/wiki/Unix) ([SVR(https://en.wikipedia.org/wiki/UNIX_System_V#SVR4))[[1\]](https://en.wikipedia.org/wiki/Illumos#cite_note-1) |
| Working state                                                | Current                                                      |
...
| Platforms                                                    | [IA-(https://en.wikipedia.org/wiki/IA-32), [x86-(https://en.wikipedia.org/wiki/X86-64), [SPARC](https://en.wikipedia.org/wiki/SPARC), [ARM](https://en.wikipedia.org/wiki/ARM_architecture) (under development)[[2\]](https://en.wikipedia.org/wiki/Illumos#cite_note-2) |
...
| Major [implementations](https://en.wikipedia.org/wiki/Programming_language_implementation) | [V(https://en.wikipedia.org/wiki/V8_(JavaScript_engine)), [JavaScriptCore](https://en.wikipedia.org/wiki/JavaScriptCore), [SpiderMonkey](https://en.wikipedia.org/wiki/SpiderMonkey_(JavaScript_engine)), [Chakra](https://en.wikipedia.org/wiki/Chakra_(JScript_engine) |
...
LinuxはもともとIntel x86アーキテクチャをベースにしたパーソナルコンピュータ向けに開発されたが、その後、他のどのオペレーティングシステムよりも多くのプラットフォームに移植されている Linuxは、サーバーやメインフレームコンピュータなどの大規模な鉄のシステムでは主要なオペレーティングシステムであり、TOP500スーパーコンピュータで使用されている唯一のOSである（2017年11月以降、徐々に競合他社を排除している）。  デスクトップコンピュータの約2.3%で使用されている LinuxカーネルベースのChromebook OSを搭載したChromebookは、米国のK-12教育市場を席巻しており、米国における300ドル以下のノートPCの売上の20%近くを占めている。
...
| Platforms                                                    | [Alpha](https://en.wikipedia.org/wiki/DEC_Alpha), [ARC](https://en.wikipedia.org/wiki/ARC_(processor)), [ARM](https://en.wikipedia.org/wiki/ARM_architecture), [C6x](https://en.wikipedia.org/wiki/C6x), [H8/(https://en.wikipedia.org/wiki/H8/300), [Hexagon](https://en.wikipedia.org/wiki/Qualcomm_Hexagon), [Itanium](https://en.wikipedia.org/wiki/Itanium), [m68k](https://en.wikipedia.org/wiki/M68k), [Microblaze](https://en.wikipedia.org/wiki/Microblaze), [MIPS](https://en.wikipedia.org/wiki/MIPS_architecture), NDS32, [Nios II](https://en.wikipedia.org/wiki/Nios_II), [OpenRISC](https://en.wikipedia.org/wiki/OpenRISC), [PA-RISC](https://en.wikipedia.org/wiki/PA-RISC), [PowerPC](https://en.wikipedia.org/wiki/PowerPC), [RISC-V](https://en.wikipedia.org/wiki/RISC-V), [s(https://en.wikipedia.org/wiki/S390), [SuperH](https://en.wikipedia.org/wiki/SuperH), [SPARC](https://en.wikipedia.org/wiki/SPARC), [Unicore(https://en.wikipedia.org/wiki/Unicore32), [x(https://en.wikipedia.org/wiki/X86), [XBurst](https://en.wikipedia.org/wiki/XBurst), [Xtensa](https://en.wikipedia.org/wiki/Xtensa) |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Monolithic](https://en.wikipedia.org/wiki/Monolithic_kernel) |
...
| Default [user interface](https://en.wikipedia.org/wiki/User_interface) | [Unix shell](https://en.wikipedia.org/wiki/Unix_shell)       |
| [License](https://en.wikipedia.org/wiki/Software_license)    | [GPLv(https://en.wikipedia.org/wiki/GPLv2)[[7\]](https://en.wikipedia.org/wiki/Linux#cite_note-8) and others (the name "Linux" is a trademark[[b\]](https://en.wikipedia.org/wiki/Linux#cite_note-10)) |
...
| [Available in](https://en.wikipedia.org/wiki/Natural_language) | English                                                      |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Monolithic](https://en.wikipedia.org/wiki/Monolithic_kernel) |
| [License](https://en.wikipedia.org/wiki/Software_license)    | [GPLv(https://en.wikipedia.org/wiki/GNU_General_Public_License) with some code under compatible GPL variants or under permissive licenses like BSD, MIT etc.[[5\]](https://en.wikipedia.org/wiki/Linux_kernel#cite_note-Linux_Licensing-5) |
...
| Platforms                                                    | [x86-(https://en.wikipedia.org/wiki/X86-64), [arm(https://en.wikipedia.org/wiki/Arm64), [armel](https://wiki.debian.org/ArmEabiPort), [armhf](https://en.wikipedia.org/wiki/Armhf), [i(https://en.wikipedia.org/wiki/I386), [mips](https://en.wikipedia.org/wiki/MIPS_architecture), [mipsel](https://en.wikipedia.org/wiki/Mipsel), [mips64el](https://en.wikipedia.org/wiki/MIPS_architecture), [ppc64el](https://en.wikipedia.org/wiki/Ppc64el), [s390x](https://en.wikipedia.org/wiki/S390x),[[3\]](https://en.wikipedia.org/wiki/Debian#cite_note-3) [riscv(https://en.wikipedia.org/wiki/RISC-V) (in progress)[[4\]](https://en.wikipedia.org/wiki/Debian#cite_note-4) |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Linux kernel](https://en.wikipedia.org/wiki/Linux_kernel)   |
...
| [Latest release](https://en.wikipedia.org/wiki/Software_release_life_cycle) | [Ubuntu 20.(https://en.wikipedia.org/wiki/Ubuntu_version_history#2004) / 23 April 2020 (2 days ago) |
...
| Platforms                                                    | [IA-(https://en.wikipedia.org/wiki/IA-32), [x86-(https://en.wikipedia.org/wiki/X86-64)[ARM(https://en.wikipedia.org/wiki/ARM64), [ARMhf](https://en.wikipedia.org/wiki/ARMhf) ([ARMv(https://en.wikipedia.org/wiki/ARMv7) + [VFPv3-D(https://en.wikipedia.org/wiki/VFPv3-D16))[ppc64le](https://en.wikipedia.org/wiki/Ppc64le) ([POWER(https://en.wikipedia.org/wiki/POWER8) and later)[s390x](https://en.wikipedia.org/wiki/S390x)[[4\]](https://en.wikipedia.org/wiki/Ubuntu#cite_note-supported_hardware-4) |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Linux kernel](https://en.wikipedia.org/wiki/Linux_kernel)   |
| [Userland](https://en.wikipedia.org/wiki/User_space#USERLAND) | [GNU](https://en.wikipedia.org/wiki/GNU_Core_Utilities)      |
...
| Platforms                                                    | [x86-(https://en.wikipedia.org/wiki/X86-64); [ARM(https://en.wikipedia.org/wiki/ARM64); [IBM Z](https://en.wikipedia.org/wiki/IBM_Z); [IBM Power Systems](https://en.wikipedia.org/wiki/IBM_Power_Systems)[[3\]](https://en.wikipedia.org/wiki/Red_Hat_Enterprise_Linux#cite_note-3) |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Linux](https://en.wikipedia.org/wiki/Linux_kernel)          |
| [Userland](https://en.wikipedia.org/wiki/User_space#USERLAND) | [GNU](https://en.wikipedia.org/wiki/GNU_Core_Utilities)      |
| Default [user interface](https://en.wikipedia.org/wiki/User_interface) | [GNOME Shell](https://en.wikipedia.org/wiki/GNOME_Shell)     |
...
| [Available in](https://en.wikipedia.org/wiki/Natural_language) | Multilingual                                                 |
| Update method                                                | [Zypper](https://en.wikipedia.org/wiki/Zypper) / [YaST(https://en.wikipedia.org/wiki/YaST2) |
...
| Platforms                                                    | [IA-(https://en.wikipedia.org/wiki/IA-32) (except SLES 12 and 15), [x86-(https://en.wikipedia.org/wiki/X86-64), [s390x](https://en.wikipedia.org/wiki/S390x), [PowerPC](https://en.wikipedia.org/wiki/PowerPC), [aarch(https://en.wikipedia.org/w/index.php?title=Aarch32&action=edit&redlink=1), [aarch(https://en.wikipedia.org/wiki/Aarch64) |
...
OpenBSD の名前の中の "open" という単語は、オペレーティングシステムのソースコードが インターネット上で利用可能であることを指しています。また、システムがサポートするハードウェアプラットフォームの広い範囲を指しています。
...
| Platforms                                                    | [x(https://en.wikipedia.org/wiki/X86_architecture) / [Vx(https://en.wikipedia.org/wiki/Vx32), [x86-(https://en.wikipedia.org/wiki/X86-64), [MIPS](https://en.wikipedia.org/wiki/MIPS_architecture), [DEC Alpha](https://en.wikipedia.org/wiki/DEC_Alpha), [SPARC](https://en.wikipedia.org/wiki/SPARC), [PowerPC](https://en.wikipedia.org/wiki/PowerPC), [ARM](https://en.wikipedia.org/wiki/ARM_architecture) |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Hybrid kernel](https://en.wikipedia.org/wiki/Hybrid_kernel) |
| Influenced by                                                | [Research Unix](https://en.wikipedia.org/wiki/Research_Unix), [Cambridge Distributed Computing System](https://en.wikipedia.org/wiki/Cambridge_Distributed_Computing_System)[[3\]](https://en.wikipedia.org/wiki/Plan_9_from_Bell_Labs#cite_note-design-paper-3) |
| Default [user interface](https://en.wikipedia.org/wiki/User_interface) | [rio](https://en.wikipedia.org/wiki/Rio_(windowing_system)) / [rc](https://en.wikipedia.org/wiki/Rc) |
| [License](https://en.wikipedia.org/wiki/Software_license)    | [Lucent Public License](https://en.wikipedia.org/wiki/Lucent_Public_License) or [GPLv(https://en.wikipedia.org/wiki/GNU_General_Public_License)[[4\]](https://en.wikipedia.org/wiki/Plan_9_from_Bell_Labs#cite_note-4) |
| Succeeded by                                                 | [Inferno](https://en.wikipedia.org/wiki/Inferno_(operating_system)) |
| Official website                                             | [9p.io/plan(https://9p.io/plan9)                           |
...
Solaris は、特に SPARC システムでのスケーラビリティの高さで知られており、DTrace、ZFS、Time Slider などの多くの革新的な機能を生み出してきました。Solaris は、Single UNIX 仕様に準拠するものとして登録されています。

歴史的に、Solarisはプロプライエタリなソフトウェアとして開発されてきました。2005年6月、Sun Microsystemsは、CDDLライセンスの下でコードベースの大部分をリリースし、OpenSolarisオープンソースプロジェクトを設立しました。 SunはOpenSolarisで、ソフトウェアを中心とした開発者とユーザーのコミュニティを構築したいと考えていました。2010年1月のSun Microsystemsの買収後、OracleはOpenSolarisディストリビューションと開発モデルを中止することを決定しました 2010年8月、OracleはSolarisカーネルのソースコードの公開アップデートの提供を中止し、事実上、Solaris 11をクローズドソースのプロプライエタリなオペレーティングシステムに戻しました その後、OpenSolarisは illumosとしてフォークされ、いくつかの illumos ディストリビューションを通じて生き続けています。

2011年には、Solaris 11カーネルのソースコードがBitTorrentに流出しました。 しかし、Oracle Technology Network（OTN）を通じて、業界パートナーは開発中のSolarisのソースコードにアクセスすることができます。 Solarisはプロプライエタリな開発モデルの下で開発されており、Solaris 11のオープンソースコンポーネントのソースのみがOracleからダウンロード可能です。



| [Developer](https://en.wikipedia.org/wiki/Software_developer) | [Sun Microsystems](https://en.wikipedia.org/wiki/Sun_Microsystems) ([acquired](https://en.wikipedia.org/wiki/Sun_acquisition_by_Oracle) by [Oracle Corporation](https://en.wikipedia.org/wiki/Oracle_Corporation) in 2009) |
| :----------------------------------------------------------- | ------------------------------------------------------------ |
| [Written in](https://en.wikipedia.org/wiki/Programming_language) | [C](https://en.wikipedia.org/wiki/C_(programming_language)), [C++](https://en.wikipedia.org/wiki/C%2B%2B) |
| OS family                                                    | [Unix](https://en.wikipedia.org/wiki/Unix)                   |
| Working state                                                | Current                                                      |
...
| [Latest release](https://en.wikipedia.org/wiki/Software_release_life_cycle) | 11.4[[1\]](https://en.wikipedia.org/wiki/Solaris_(operating_system)#cite_note-1) / August 28, 2018; 19 months ago |
| Marketing target                                             | [Server](https://en.wikipedia.org/wiki/Server_(computing)), [workstation](https://en.wikipedia.org/wiki/Workstation) |
| Platforms                                                    | [SPARC](https://en.wikipedia.org/wiki/SPARC), [x86-(https://en.wikipedia.org/wiki/X86-64), [IA-(https://en.wikipedia.org/wiki/IA-32) (except Solaris 11), [PowerPC](https://en.wikipedia.org/wiki/PowerPC) (Solaris 2.5.1 only) |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Monolithic](https://en.wikipedia.org/wiki/Monolithic_kernel) with [dynamically loadable modules](https://en.wikipedia.org/wiki/Loadable_kernel_module) |
| Default [user interface](https://en.wikipedia.org/wiki/User_interface) | [GNOME](https://en.wikipedia.org/wiki/GNOME)[[2\]](https://en.wikipedia.org/wiki/Solaris_(operating_system)#cite_note-2) |
| [License](https://en.wikipedia.org/wiki/Software_license)    | Various                                                      |
| Official website                                             | [www.oracle.com/solaris](https://www.oracle.com/solaris)     |
...
Microsoftは1985年11月20日に、グラフィカル・ユーザー・インターフェース（GUI）への関心の高まりに対応して、MS-DOSのグラフィカル・オペレーティング・システム・シェルとしてWindowsという名前のオペレーティング環境を導入した。Appleは、LisaやMacintoshなどの製品に搭載されたGUI開発の革新性を、Windowsが不当に侵害していると考えるようになりました（最終的には1993年にMicrosoftの有利な裁判で和解しました）。PCでは、Windowsは今でも最も普及しているOSである。しかし、2014年にマイクロソフトは、Androidスマートフォンの販売が大幅に伸びたことを理由に、OS全体の市場の大半をAndroidに失ったことを認めた。2014年のWindows端末の販売台数は、Android端末の販売台数の25%以下だった。しかし、2つのオペレーティングシステムは伝統的に異なるプラットフォームをターゲットにしているため、この比較は完全に関連性があるとは言えないかもしれません。それでも、（競合他社と比較できる）Windowsのサーバー利用の数字は、エンドユーザー利用の数字と同様に、3分の1の市場シェアを示しています。

2020年2月現在、PC、タブレット、組み込み機器向けのWindowsの最新バージョンはWindows 10です。サーバーコンピュータ用の最新バージョンはWindows Serverのバージョン1909である。



| [Developer](https://en.wikipedia.org/wiki/Software_developer) | [Microsoft](https://en.wikipedia.org/wiki/Microsoft)         |
| :----------------------------------------------------------- | ------------------------------------------------------------ |
| Source model                                                 | [Closed-source](https://en.wikipedia.org/wiki/Proprietary_software)[Source-available](https://en.wikipedia.org/wiki/Source-available_software) (through [Shared Source Initiative](https://en.wikipedia.org/wiki/Shared_Source_Initiative)) |
| Initial release                                              | November 20, 1985; 34 years ago, as version 1.0 (unsupported) |
| [Latest release](https://en.wikipedia.org/wiki/Software_release_life_cycle) | 1909 (10.0.18363.752) March 24, 2020 (32 days ago)           |
| [Latest preview](https://en.wikipedia.org/wiki/Software_release_life_cycle) | 10.0.19592 March 25, 2020 (31 days ago)                      |
| Marketing target                                             | Personal computing                                           |
| [Available in](https://en.wikipedia.org/wiki/Natural_language) | 138 languages[[1\]](https://en.wikipedia.org/wiki/Microsoft_Windows#cite_note-1) |
| Update method                                                | [Windows Update](https://en.wikipedia.org/wiki/Windows_Update)[Windows Anytime Upgrade](https://en.wikipedia.org/wiki/Windows_Anytime_Upgrade)[Windows Store](https://en.wikipedia.org/wiki/Windows_Store)[Windows Server Update Services](https://en.wikipedia.org/wiki/Windows_Server_Update_Services) (WSUS) |
| [Package manager](https://en.wikipedia.org/wiki/Package_manager) | [Windows Installer](https://en.wikipedia.org/wiki/Windows_Installer) (.msi, .msix, .msp), [executable file](https://en.wikipedia.org/wiki/Executable_file) (.exe), [Universal Windows Platform](https://en.wikipedia.org/wiki/Universal_Windows_Platform) ([.appx](https://en.wikipedia.org/wiki/APPX), .appxbundle)[[2\]](https://en.wikipedia.org/wiki/Microsoft_Windows#cite_note-2) |
| Platforms                                                    | [IA-(https://en.wikipedia.org/wiki/IA-32), [x86-(https://en.wikipedia.org/wiki/X86-64), [ARM](https://en.wikipedia.org/wiki/ARM_architecture), [ARM(https://en.wikipedia.org/wiki/ARM64) Previously: [16-bit x(https://en.wikipedia.org/wiki/X86), [DEC Alpha](https://en.wikipedia.org/wiki/DEC_Alpha), [MIPS](https://en.wikipedia.org/wiki/MIPS_architecture), [PowerPC](https://en.wikipedia.org/wiki/PowerPC), [Itanium](https://en.wikipedia.org/wiki/Itanium) |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Windows NT](https://en.wikipedia.org/wiki/Windows_NT) family: [Hybrid](https://en.wikipedia.org/wiki/Hybrid_kernel)[Windows CE](https://en.wikipedia.org/wiki/Windows_Embedded_Compact): [Hybrid](https://en.wikipedia.org/wiki/Hybrid_kernel)[Windows 9x](https://en.wikipedia.org/wiki/Windows_9x) and earlier: [Monolithic](https://en.wikipedia.org/wiki/Monolithic_kernel) ([MS-DOS](https://en.wikipedia.org/wiki/MS-DOS)) |
| Default [user interface](https://en.wikipedia.org/wiki/User_interface) | [Windows shell](https://en.wikipedia.org/wiki/Windows_shell) |
| [License](https://en.wikipedia.org/wiki/Software_license)    | [Proprietary](https://en.wikipedia.org/wiki/Proprietary_software) [commercial software](https://en.wikipedia.org/wiki/Commercial_software) |
| Official website                                             | [microsoft.com/windows](http://microsoft.com/windows)        |
...
"NT」は以前は「新技術」に拡大されたが、現在では特定の意味を持たなくなった。Windows 2000 以降、 "NT" は製品名から削除され、製品バージョンの文字列にのみ含まれるようになった。

NT は Windows の最初の純粋な 32 ビット版であり、コンシューマ向けの Windows 3.1x と Windows 9x は 16 ビットと 32 ビットのハイブリッド版であった。NT はマルチアーキテクチャのオペレーティングシステムである。当初は、IA-32、MIPS、DEC Alphaなど、いくつかの命令セットアーキテクチャをサポートしていましたが、後にPowerPC、Itanium、x64、ARMのサポートが追加されました。最新版ではx86(より具体的にはIA-32とx64)とARMをサポートしている。Windows NTファミリーの主な機能としては、Windows Shell、Windows API、Native API、Active Directory、Group Policy、Hardware Abstraction Layer、NTFS、BitLocker、Windows Store、Windows Update、Hyper-Vなどがある。
...
ユーザーモードのプログラムやサブシステムは、アクセスできるシステムリソースが制限されていますが、カーネルモードではシステムメモリや外部デバイスへのアクセスが制限されていません。Windows NT のカーネルモードは、コンピュータのハードウェアとシステムリソースに完全にアクセスできます。Windows NT カーネルはハイブリッドカーネルであり、アーキテクチャはシンプルなカーネル、ハードウェア抽象化層 (HAL)、ドライバ、および一連のサービス (総称して Executive と呼ばれる) から構成されており、これらはすべてカーネルモードで存在する。

Windows NTのユーザモードは、I/Oマネージャを使用して適切なカーネルモードのデバイスドライバにI/O要求を渡すことができるサブシステムで構成されている。Windows NTのユーザーモード層は、多くの異なるタイプのオペレーティングシステム用に書かれたアプリケーションを実行する「環境サブシステム」と、環境サブシステムに代わってシステム固有の機能を動作させる「統合サブシステム」で構成されています。カーネルモードは、ユーザーモードのサービスやアプリケーションが、アクセスすべきではないオペレーティングシステムの重要な領域にアクセスすることを阻止します。

すべてのユーザモードのサブシステムとの Executive インターフェースは、I/O、オブジェクト管理、セキュリティ、プロセス管理を扱います。カーネルは、ハードウェア抽象化レイヤとエグゼクティブの間に位置し、マルチプロセッサの同期化、スレッドと割込みのスケジューリングとディスパッチ、トラップ処理と例外ディスパッチを提供します。カーネルは、起動時にデバイスドライバの初期化も行います。カーネルモードのドライバは、最高レベルのドライバ、中間レベルのドライバ、低レベルのドライバの3つのレベルで存在します。Windows Driver Model (WDM) は中間層に存在し、主に Windows 98 と Windows 2000 の間でバイナリとソースの互換性があるように設計されています。最低レベルのドライバは、デバイスを直接制御するレガシーな Windows NT デバイスドライバか、プラグアンドプレイ (PnP) ハードウェアバスのいずれかです。



| [Developer](https://en.wikipedia.org/wiki/Software_developer) | [Microsoft](https://en.wikipedia.org/wiki/Microsoft)         |
| :----------------------------------------------------------- | ------------------------------------------------------------ |
| [Written in](https://en.wikipedia.org/wiki/Programming_language) | [C](https://en.wikipedia.org/wiki/C_(programming_language)), [C++](https://en.wikipedia.org/wiki/C%2B%2B), and [Assembly language](https://en.wikipedia.org/wiki/Assembly_language)[[1\]](https://en.wikipedia.org/wiki/Windows_NT#cite_note-1) |
| Working state                                                | Current                                                      |
| Source model                                                 | [Closed-source](https://en.wikipedia.org/wiki/Proprietary_software)[Source-available](https://en.wikipedia.org/wiki/Source-available_software) (through [Shared Source Initiative](https://en.wikipedia.org/wiki/Shared_Source_Initiative)) |
| Initial release                                              | July 27, 1993; 26 years ago (as [Windows NT 3.(https://en.wikipedia.org/wiki/Windows_NT_3.1)) |
| [Latest release](https://en.wikipedia.org/wiki/Software_release_life_cycle) | Windows 10, version 1909 (10.0.18363.815) April 21, 2020; 4 days ago |
| [Latest preview](https://en.wikipedia.org/wiki/Software_release_life_cycle) | Windows 10, Insider Fast Ring (10.0.19613.1000) April 22, 2020; 3 days ago Windows 10, version 2004 (10.0.19041.207) April 14, 2020; 11 days ago |
| Update method                                                | [Windows Update](https://en.wikipedia.org/wiki/Windows_Update), [Windows Server Update Services](https://en.wikipedia.org/wiki/Windows_Server_Update_Services) |
| Platforms                                                    | [IA-(https://en.wikipedia.org/wiki/IA-32), [x86-(https://en.wikipedia.org/wiki/X86-64) and [ARM](https://en.wikipedia.org/wiki/ARM_architecture) (and historically [DEC Alpha](https://en.wikipedia.org/wiki/DEC_Alpha), [Itanium](https://en.wikipedia.org/wiki/Itanium), [MIPS](https://en.wikipedia.org/wiki/MIPS_architecture), and [PowerPC](https://en.wikipedia.org/wiki/PowerPC)) |
| [Kernel](https://en.wikipedia.org/wiki/Kernel_(operating_system)) type | [Hybrid](https://en.wikipedia.org/wiki/Hybrid_kernel)        |
...
[MS-DOS(en.wikipedia)](https://en.wikipedia.org/wiki/MS-DOS)
...
IBMは1981年にPC DOS 1.0としてライセンスを取得して再リリースし、そのPCで使用するようになりました。MS-DOSとPC DOSは当初、MicrosoftとIBMによって並行して開発されましたが、12年後の1993年には、互換性、構文、機能に明確な違いがあり、2つの製品は分岐しました。

その間、いくつかの競合製品がx86プラットフォーム用にリリースされ、MS-DOSは2000年に開発が終了するまで8つのバージョンを経てきました。当初、MS-DOSは、オペレーティング・システムだけでなく、アプリケーション・ソフトウェアやユーザー・データを保存し、アクセスするためにフロッピー・ディスクを使用するコンピュータ・ハードウェア上で動作するIntel 8086プロセッサをターゲットにしていました。進歩的なバージョンのリリースでは、より大きなサイズとフォーマットの他の大容量ストレージメディアのサポートが提供され、さらに新しいプロセッサと急速に進化するコンピュータアーキテクチャのための機能サポートが追加されました。最終的には、マイクロソフトがプログラミング言語会社から多様なソフトウェア開発会社へと発展していく上で重要な製品となり、同社に不可欠な収益とマーケティングリソースを提供しました。また、初期バージョンのWindowsがGUIとして動作する基本的なオペレーティングシステムでもありました。柔軟性の高いオペレーティングシステムであり、インストールスペースをほとんど消費しません。

### 歴史

MS-DOSは、シアトル・コンピュータ・プロダクツ社が所有する86-DOSの名前を変更したもので、ティム・パターソンによって書かれたものである。86-DOSの開発にはわずか6週間しかかからなかった。基本的にはDigital ResearchのCP/M (808080/Z80プロセッサ用)のクローンであり、8086プロセッサ上で動作するように移植され、CP/Mと比べて2つの顕著な違いがあった。この最初のバージョンは1980年8月に出荷された MicrosoftはIBMパーソナルコンピュータ用のオペレーティングシステムを必要としていたが、1981年5月にTim Patersonを雇い、同年7月に86-DOS 1.10を75000ドルで購入した。マイクロソフトはバージョン番号を維持したが、MS-DOSと改名した。また、MS-DOS 1.10/1.14をIBMにライセンスしたIBMは、1981年8月、IBM 5150またはIBM PC用の3つのオペレーティングシステムのうちの1つとして、PC DOS 1.0として提供した。

1年以内に、Microsoftは70社以上の企業にMS-DOSのライセンスを与えた。各コンピュータは、CP/Mに存在した状況に似た、独自のハードウェアと独自のバージョンのMS-DOSを持つことになり、MS-DOSはCP/Mと同じソリューションをエミュレートして、異なるハードウェアプラットフォームに適応することになる。この目的のために、MS-DOSは、内部デバイスドライバ(DOS BIOS)を備えたモジュール構造で設計されており、最小限のプライマリディスクドライブとコンソール用に、カーネルと統合され、ブートローダによってロードされ、ブート時にロードされ統合された他のデバイス用のインストール可能なデバイスドライバを備えています。OEM は、Microsoft が提供する開発キットを使用して、基本的な I/O ドライバと標準的な Microsoft カーネルを搭載した MS-DOS のバージョンを構築します。このように、異なるハードウェア用に多くの異なるバージョンの「MS-DOS」があり、IBM互換(またはISA)マシンとMS-DOS [互換性のある]マシンの間には大きな違いがあります。Tandy 2000のようないくつかのマシンは、MS-DOS互換ではあるがIBM互換ではなかったので、IBM PCアーキテクチャの周辺ハードウェアに依存することなく、MS-DOS専用に書かれたソフトウェアを実行することができました。

この設計は、アプリケーションプログラムがデバイスのI/Oを実行するためにMS-DOSのサービスだけを使用していれば、互換性を保つためにうまく機能していただろうし、実際、同じ設計哲学がWindows NTにも具現化されている(ハードウェア抽象化レイヤーを参照)。しかし、MS-DOSの初期の頃は、ハードウェアを直接制御することでプログラムが達成できる速度の向上が特に重要であり、特にゲームでは、しばしば現代のハードウェアの限界を押し広げることがありました。すぐにIBM互換のアーキテクチャが目標となり、やがてすべての8086ファミリーコンピュータがIBMのハードウェアを密接にエミュレートするようになり、固定ハードウェアプラットフォーム用のMS-DOSの単一バージョンだけが市場に必要とされるようになりました。MS-DOS」の他の何十ものOEMバージョンは、それらが設計されたシステムにのみ関連していたため、このバージョンがここで議論されるMS-DOSのバージョンとなっている。

Microsoftは、MicrosoftのUnixベースのオペレーティングシステムであるXenixが完全にマルチユーザであったため、MS-DOSからマルチユーザのサポートを省略した 。 同社は、時間をかけてMS-DOSを改良し、シングルユーザのXenixやXEDOSとほとんど区別がつかなくなるようにすることを計画していた。  MicrosoftはMS-DOSとXenixを一緒に宣伝し、「シングルユーザOS」と「マルチユーザでマルチタスクなUNIX由来のオペレーティングシステム」という共通の機能を挙げ、両者間の移植が容易であることを約束した。しかし、Bell Systemの崩壊後、AT&T Computer SystemsがUNIX System Vの販売を開始した。

2014年3月25日、マイクロソフトはSCP MS-DOS 1.25とAltos MS-DOS 2.11とTeleVideo PC DOS 2.11の混合版へのコードをMicrosoft Research License Agreementの下で一般に公開したが、これはコードをソース利用可能なものとしているが、Open Source InitiativeやFree Software Foundationの基準で定義されているオープンソースではない マイクロソフトはその後、2018年9月28日にMIT Licenseの下でコードを再ライセンスし、これらのバージョンをフリーソフトウェアとした。

2015年のエイプリルフールのジョークとして、Microsoft MobileはMS-DOS Mobileと呼ばれるWindows Phoneアプリケーションを発表したが、これは新しいモバイルオペレーティングシステムとして発表され、MS-DOSと同様の動作をした。



### End of MS-DOS

Microsoft Windows のすべてのバージョンには、コマンドプロンプトと呼ばれる MS-DOS ライクなコマンドラインインターフェイス (CLI) がありました。これは、多くのDOSや様々なWin32、OS/2 1.x、POSIXのコマンドラインユーティリティを同じコマンドラインセッションで実行することができ、コマンド間のパイピングを可能にしていました。ユーザーインターフェイスと Windows 2000 までのアイコンは、ネイティブの MS-DOS インターフェイスに従っていました。

Windows の 16 ビット版 (3.11 まで) は MS-DOS の上にグラフィカル・ユーザー・インターフェース (GUI) として動作しました。Windows 95、98、98 SE、および Me では、MS-DOS の部分は（表面的には）統合されており、MS-DOS オペレーティング システムと Windows GUI を完全なパッケージとして扱いましたが、DOS コンポーネントは実際には独立していました。コマンドラインは、Windows モジュール (WINOLDAP.MOD) を介して DOS コマンドライン (通常は COMMAND.COM) にアクセスします。

Windows の新しいライン (Windows NT) は、Windows をロードすることだけを目的としたカーネルを介して起動します。OS/2, UNIX, Consumer Windowsが文字モードセッションを起動できるような方法では、ローダシステムでWin32アプリケーションを実行することはできません。

コマンドセッションは、Win32、MS-DOS、OS/2 1.x、POSIXからサポートされている様々なコマンドラインユーティリティの実行を許可します。MS-DOS、OS/2、POSIX用のエミュレータは、Win16アプリケーションがWin32エクスプローラを使用するのと同じ方法でホストのウィンドウを使用します。ホストのウィンドウを使うことで、エミュレーション間で出力をパイプでつなぐことができます。

MS-DOS エミュレーションは NTVDM (NT Virtual DOS Machine) を使って行われます。これはSoftPC(VirtualPCに似た旧製品)を改造したもので、MS-DOS 5(NTIO.SYSとNTDOS.SYS)を実行しています。出力はコンソールDLLで処理されるので、プロンプトのプログラム(CMD.EXE、4NT.EXE、TCC.EXE)で出力を見ることができます。64ビットWindowsには、32ビットWindowsに付属しているDOSエミュレーションやDOSコマンドEDIT、DEBUG、EDLINのいずれもありません。

DOS版では、どのAPI関数を使って判定するかによって、5.00または5.50を返します。MS-DOS 5.00のユーティリティは、このエミュレーションでは変更せずに動作します。NTの非常に初期のベータプログラムにはMS-DOS 30.00が表示されていますが、MS-DOS 30.00で動作するプログラムはOS/2が制御していると仮定しています。

OS/2エミュレーションは、OS2SS.EXEとOS2.EXE、そしてDOSCALLS.DLLで処理されます。OS2.EXEはOS/2シェル(CMD.EXE)のバージョンで、コマンドをOS2SS.EXEに渡し、入出力をWindows NTシェルに渡す。Windows 2000はOS/2をサポートするNTの最後のバージョンでした。エミュレーションはOS/2 1.30です。

POSIXはPOSIXシェルを介してエミュレートされているが、エミュレートされたシェルはなく、コマンドはCMD.EXEで直接処理される。

コマンドプロンプトはMS-DOSプロンプトと呼ばれることが多い。一部では、これは Windows 9x と Windows NT の初期バージョン (NT 3.5 以前) での正式名称であり、また一部では SoftPC の DOS エミュレーションが出力をこのプロンプトにリダイレクトするためです。実際には、COMMAND.COM とその他の 16 ビットコマンドのみが NTVDM 内で実行され、AUTOEXEC.NT と CONFIG.NT の初期化は _DEFAULT.PIF で決定されますが、オプションで Win32 コンソールアプリケーションと内部コマンドの使用を NTCMDPROMPT ディレクティブで許可しています。

Win32 コンソールアプリケーションは、コマンドプロンプトシェルとして CMD.EXE を使用します。OS/2 では、DOS と OS/2 のプロンプトが別々にあり、OS/2 で DOS プログラムを実行すると、アプリケーションを実行するための別の DOS ウィンドウが起動するため、この混乱は存在しません。

Windows for Itanium (Microsoftによって販売されなくなりました)とx86-64アーキテクチャのすべてのバージョンのWindowsにはNTVDMが含まれていないため、DOSや16ビットのWindowsアプリケーションをネイティブに実行することができなくなりました。代替手段としては、Microsoft社のVirtual PCやVMware、DOSBoxなどの仮想マシンエミュレータがあります。



### DOS

[DOS(en.wikipedia)](https://en.wikipedia.org/wiki/DOS)
...
[Disk_operating_system(en.wikipedia)](https://en.wikipedia.org/wiki/Disk_operating_system)
...
ディスクオペレーティングシステムは、メインフレーム、ミニコンピュータ、マイクロプロセッサ、家庭用コンピュータで利用可能であり、通常、起動プロセスの一部としてディスク自体からロードされていました。



#### 歴史

コンピュータの初期には、ディスクドライブやフロッピーディスク、現代のフラッシュ記憶装置はありませんでした。代わりに、ディレイライン、コアメモリ、パンチングカード、パンチングテープ、磁気テープ、磁気ドラムなどの初期の記憶装置が使用されていた。そして、マイクロコンピュータや家庭用コンピュータの初期の時代には、紙テープやオーディオカセットテープ（カンザスシティ規格参照）、あるいは何もないものが代わりに使用されていた。後者の場合、プログラムやデータの入力は、フロントパネルのスイッチで直接メモリに入力するか、コンピュータターミナル/キーボードを介して行われ、時にはROM内のBASICインタプリタによって制御されていた。

1960年代初頭には、ディスクドライブがより大きく、より手頃な価格になったため、様々なメインフレームやミニコンピュータのベンダーがディスクオペレーティングシステムを導入し、既存のオペレーティングシステムをディスクを利用するように変更し始めました。

ハードディスクもフロッピーディスクドライブも、シーケンシャルデータやその他のデータのブロックストレージへの迅速なアクセスを管理するためのソフトウェアを必要とします。ほとんどのマイクロコンピュータでは、ディスクドライブはオプションの周辺機器でした。オペレーティングシステムのディスク・オペレーティング・システム・コンポーネントは、ディスク・ドライブが使用されている場合にのみ必要とされた。

IBMがSystem/360メインフレームを発表した頃には、ディスクオペレーティングシステムの概念が確立されていました。IBMは小型システム向けにBasic Programming Support (BPS/360)とTOS/360を提供していましたが、それらは主流から外れており、ほとんどの顧客はDOS/360かOS/360を使用していました。

1970年代後半から1980年代にかけての家庭用コンピュータやパーソナルコンピュータのほとんどは、ディスクオペレーティングシステムを使用していましたが、ほとんどの場合、名前に「DOS」が入っており、それぞれのコミュニティ内では単に「DOS」と呼ばれていました。Commodore 8ビットシステム用のCBM DOS、Atari 8ビットファミリー用のAtari DOS、TRS-80用のTRS-DOS、Apple II用のApple DOS、IBM PC互換機用のMS-DOSなどです。

通常、ディスクオペレーティングシステムはディスクからロードされていました。例外として、CommodoreのDOSはディスクドライブのROMチップに搭載されていました。コモドール64およびコモドール128モデル用のLt. Kernalハードディスクサブシステムは、最新のシステムと同様にDOSをディスク上に保存し、起動時にDOSをRAMにロードしました。イギリスのBBCマイクロのオプションのディスクファイリングシステムDFSは、ディスクコントローラチップ、ROMチップ、および一握りのロジックチップを含むキットとして提供され、コンピュータ内部にインストールされました。



### DOS in Dictionary

[DOS (Disk Operating System)](https://searchsecurity.techtarget.com/definition/DOS)
...
ディスクオペレーティングシステムは、いくつかの非常に類似したコマンドラインディスクオペレーティングシステムを記述するためにも使用されます。PC-DOS (Personal Computer Disk Operating System) は、Intel 8086 16ビットプロセッサ上で動作するパーソナルコンピュータで使用される最初の広くインストールされたディスクオペレーティングシステムでした。これはマイクロソフト社によってIBMのために開発されたもので、マイクロソフト社もMS-DOSと呼ばれるほぼ同一のバージョンを製造していました。当時の他のコンピュータ、例えばコモドール64、アタリ800、アップルIIは、それぞれCBM DOS、アタリDOS、アップルDOSというディスク・オペレーティング・システムを搭載していました。(DOS/360は1966年に初めて登場したIBMメインフレーム用のオペレーティングシステムであるが、1980年代の8086ベースのDOSとは無関係である。
...
これらの「クローン」は、IBMのPCアーキテクチャの重要な機能をほぼ正確にすべて複製しています。これは、IBMがコモディティなハードウェアコンポーネントを選択したことと、様々なメーカーが「クリーンルームデザイン」技術を使ってBIOSファームウェアをリバースエンジニアリングする能力を持っていることによって容易になりました。Columbia Data Productsは、そのBIOSをクリーンルームで実装してIBMパーソナルコンピュータの最初のクローンを構築しました[citation needed]。

初期のIBM PC互換機は、オリジナルのPCやATモデルと同じコンピュータバスを使用していました。IBM AT互換バスは、後に互換性のあるコンピュータのメーカーによって業界標準アーキテクチャ（ISA）バスと呼ばれるようになりました。

IBM PC互換機の子孫は、現在市場に出回っているパーソナルコンピュータの大部分を構成しており、主要なオペレーティング・システムはMicrosoft Windowsですが、オリジナルPCアーキテクチャのバス構造や周辺機器との相互運用性は限られているか、存在しないかもしれません。これらのコンピュータの中には、MS-DOSを実行するものもありますが、IBM互換のソフトウェアを使用できないほどのハードウェアの違いがありました。

マッキントッシュだけが、IBM PCとの互換性を持たずに大きな市場シェアを維持していました。
...
AndroidアプリがOSで利用できるようになったのは2014年からで、2016年にはサポートされているChrome OS端末でGoogle PlayのAndroidアプリ全体へのアクセスが導入されました。Project Crostiniとして知られるLinux端末とアプリケーションのサポートは、Chrome OS 69の安定版チャンネルにリリースされた。これは、仮想マシン内でコンテナを実行する軽量な Linux カーネルによって実現された。

Chrome OSはGoogleの製造パートナーからハードウェアにプリインストールされているだけだが、他の機器にインストールできる非公式な方法もある。 そのオープンソースのアップストリームであるChromium OSは、ダウンロードしたソースコードからコンパイルできる。初期の段階では、GoogleはChromium OSの設計目標を提示していたが、それ以外の技術的な説明は公開していない。



| [Developer](https://en.wikipedia.org/wiki/Software_developer) | [Google](https://en.wikipedia.org/wiki/Google)               |
| :----------------------------------------------------------- | ------------------------------------------------------------ |
| [Written in](https://en.wikipedia.org/wiki/Programming_language) | [C](https://en.wikipedia.org/wiki/C_(programming_language)), [C++](https://en.wikipedia.org/wiki/C%2B%2B), [JavaScript](https://en.wikipedia.org/wiki/JavaScript), [HTML(https://en.wikipedia.org/wiki/HTML5), [Python](https://en.wikipedia.org/wiki/Python_(programming_language)) |
...
| Platforms                                                    | [arm](https://en.wikipedia.org/wiki/Arm), [arm(https://en.wikipedia.org/wiki/Arm64), [x(https://en.wikipedia.org/wiki/X86), [x(https://en.wikipedia.org/wiki/X64) |
...
| [Userland](https://en.wikipedia.org/wiki/User_space#USERLAND) | Ozone (Display manager), [X(https://en.wikipedia.org/wiki/X11) |
